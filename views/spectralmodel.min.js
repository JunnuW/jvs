...
$("#openFile").click(function(){$("#settnDial").dialog("close");DFmngo.dialog("option","width","700px").dialog("option","height","auto").dialog("option","title",srvrFileTxt).dialog("open");$("#frm-DirSel").show();$("#openOpti").css("display","inline")});
