...
function homogSettns_dialog(){$("#spSech").css("display","none");$("#spGaussian").css("display","none");$("#spSurbach").css("display","none");$("#spUrbach").css("display","none");$("#spWhat").css("display","block");$("#bConvolOpt").text("Homogeneous broadening options for Lh:");$("#divEpsilon").css("display","block");$("#divJdos").css("display","block");$("#divSommerf").css("display","block");$("#divFcv").css("display","block");$("#divUrbach").css("display","none");$("#divSurbach").css("display",
