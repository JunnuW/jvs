...
var optiot={xaxes:[{position:"bottom",axisLabel:"Energy eV (axis-click to edit graph)"}],yaxes:[{position:"left",axisLabel:"Relative Intensity"}],legend:{position:"ne"},grid:{margin:{top:35},hoverable:"Relative Intensity"},canvas:!0},plot=$.plot("#ph1_inhomog",[],optiot),plot2=$.plot("#ph2_homog",[],optiot),dataa=[{data:LinOrLogs(graphSettn.inhomLinlog,inhomSpectr.plotArr,plot),xaxis:1,yaxis:1,label:graphSettn.inhomLegend}];
...
function setJdosRadio(){"bulk"==simSettn.jdostype?($("#bulkJDOS").prop("checked",!0),$("#qwendetls").css("display","none"),$("#haideri").css("display","none"),$("#qwdetails .hideshow").hide()):($("#qwJDOS").prop("checked",!0),$("#qwendetls").css("display","inline"),$("#qwdetails .hideshow").show())}makeJdos();makeBoltz();setChkboxes();setLegend();makeSommer();calcInhom();
$("#paramDial").dialog({width:700,autoOpen:!1,maxHeight:"700px",overflow:"auto",show:{effect:"blind",duration:500},hide:{effect:"explode",duration:200}});$("#settnDial").dialog({width:700,autoOpen:!1,maxHeight:"700px",overflow:"auto",show:{effect:"blind",duration:500},hide:{effect:"explode",duration:200}});var srvrFileTxt="Open emission spectrum",DFmngo=$("#mongoDialForm");DFmngo.dialog("option","title",srvrFileTxt);
$("#openMeasFile").click(function(){$("#settnDial").dialog("close");DFmngo.dialog("option","width","700px").dialog("option","height","auto").dialog("option","title","Open emission spectrum").dialog("open");$("#frm-DirSel").show();$("#openOpti").css("display","inline")});
$("#openSimFile").click(function(){$("#settnDial").dialog("close");DFmngo.dialog("option","width","700px").dialog("option","height","auto").dialog("option","title","Open simulated spectrum").dialog("open");$("#frm-DirSel").show();$("#openOpti").css("display","inline")});
$("#saveMeasFile").click(function(){var a=$("#settnDial").dialog("option","title");$("#saaveSim").hide();$("#settnDial").dialog("close");a="Save "+a;DFmngo.dialog("option","width","700px").dialog("option","title",a).dialog("open");$("#openOpti").css("display","none")});
$("#saveSimFile").click(function(){"Inhomogeneous spectrum"==$("#settnDial").dialog("option","title")?$("#lblsaveSimSpe").text("Inhomogeneous simulation"):$("#lblsaveSimSpe").text("Homogeneous simulation");$("#settnDial").dialog("close");DFmngo.dialog("option","width","700px").dialog("option","title","Save simulation spectrum").dialog("open");$("#openOpti").css("display","none")});
...
"block");$("#divLorentz").css("display","none");$("#divDLorentz").css("display","none");$("#divHomogConv").css("display","none");$("#divNormalize").css("display","block");$("#settnDial").dialog("option","title","Inhomogeneous spectrum");$("#bPlotSel1").css("display","block");$("#bPlotSel2").css("display","none");$("#settnDial").dialog("open");setJdosRadio();setQwRadio()}
$("#ph1_inhomog").dblclick(function(){1>inhomSpectr.experArr.length?$("#saveMeasFile").attr("disabled",!0):$("#saveMeasFile").attr("disabled",!1);inhomSettns_dialog()});
...
"none");$("#divGaussian").css("display","none");$("#divSech").css("display","none");$("#divLorentz").css("display","block");$("#divDLorentz").css("display","block");$("#divHomogConv").css("display","block");$("#divNormalize").css("display","block");$("#settnDial").dialog("option","title","Homogeneous spectrum");$("#bPlotSel2").css("display","block");$("#bPlotSel1").css("display","none");$("#settnDial").dialog("open");$("#saveFile").css("display","inline")}
$("#ph2_homog").dblclick(function(){1>homSpectr.experArr.length?$("#saveMeasFile").attr("disabled",!0):$("#saveMeasFile").attr("disabled",!1);homogSettns_dialog()});$("#eVstart_touch").TouchSpin({max:4.5,min:0,step:.001,initval:simSettn.eVstart,decimals:3,boostat:10,maxboostedstep:.005,postfix:"eV",mousewheel:!0});
$("#eVstart_touch").on("touchspin.on.stopspin",function(a){a=Number($("#eVstart_touch").val());simSettn.eVstart=a.toFixed(3);a+=.1;$("#eVstop_touch").trigger("touchspin.updatesettings",{min:a})});$("#eVstop_touch").TouchSpin({max:4.5,min:0,step:Number(.001),initval:simSettn.eVstop,decimals:3,boostat:10,maxboostedstep:.005,postfix:"eV",mousewheel:!0});
...
$("input[type=radio][name=jdos]").change(function(){"bulk"==this.value?(simSettn.jdostype="bulk",$("#qwendetls").css("display","none"),$("#qwdetails .hideshow").hide(),$("#haideri").hide(),$("#enhTE").prop("checked",!0),$("#enhTM").prop("checked",!1),simSettn.polarizat="TE"):"qw"==this.value&&(simSettn.jdostype="qw",$("#qwendetls").css("display","block"),$("#qwdetails .hideshow").hide());setJdosRadio();makeJdos();makeSommer();calcInhom()});
...
$("#emisLocFiles").on("change",function(){var a=$("#emisLocFiles").get(0).files[0];if(a){var b=$("#settnDial").dialog("option","title");"Inhomogeneous spectrum"==b?(graphSettn.inhomFileN=a.name,ReadLocFle(a,gotInhomFile)):"Homogeneous spectrum"==b&&(graphSettn.homFileN=a.name,ReadLocFle(a,gotHomogFile))}});
$("#simLocFiles").on("change",function(){var a=$("#simLocFiles").get(0).files[0];if(a){var b=$("#settnDial").dialog("option","title");"Inhomogeneous spectrum"==b?(graphSettn.inhomFileN=a.name,ReadLocFle(a,gotInhomSim)):"Homogeneous spectrum"==b&&(graphSettn.homFileN=a.name,ReadLocFle(a,gotInhomSim))}});$("#footer").prepend("Flot graph"+$.plot.version+" &ndash; ");
...
function setSelections(a){inhomSpectr.inPlot.eV=0<=a.indexOf("(E)")?!0:!1;inhomSpectr.inPlot.jdos=0<=a.indexOf("(qw-jdos)")||0<=a.indexOf("(bulk-jdos)")?!0:!1;inhomSpectr.inPlot.fcv=0<=a.indexOf("(exp[(E-Etr)/kT])")?!0:!1;inhomSpectr.inPlot.Se=0<=a.indexOf("(qw-ex.Enh)")||0<=a.indexOf("(bulk-ex.Enh)")?!0:!1;inhomSpectr.inPlot.convo=!1;inhomSpectr.inPlot.Lurb=!1;inhomSpectr.inPlot.Lsurb=!1;inhomSpectr.inPlot.Lgaus=!1;inhomSpectr.inPlot.Lsech=!1;homSpectr.inPlot.convo=!1;$("#pltHomConv").prop("checked",
!1);$("#pltDlorentz").prop("checked",!1);$("#pltLorentz").prop("checked",!1);0<=a.indexOf("*(Asym.Urbach-brdng)")&&(inhomSpectr.inPlot.convo=!0,inhomSpectr.inPlot.Lurb=!0);0<=a.indexOf("*(Symm.Urbach-brdng)")&&(inhomSpectr.inPlot.convo=!0,inhomSpectr.inPlot.Lsurb=!0);0<=a.indexOf("*(Gaussian-brdng)")&&(inhomSpectr.inPlot.convo=!0,inhomSpectr.inPlot.Lgaus=!0);0<=a.indexOf("*(Sech^n(t/tau/n)-brdng)")&&(inhomSpectr.inPlot.convo=!0,inhomSpectr.inPlot.Lsech=!0);0<=a.indexOf("*(Lorentzian brdng)")&&(homSpectr.inPlot.convo=
!0,$("#pltHomConv").prop("checked",!0),$("#pltLorentz").prop("checked",!0));0<=a.indexOf("*(Lorentzian1 x Lorentzian2 brdng)")&&(homSpectr.inPlot.convo=!0,$("#pltHomConv").prop("checked",!0),$("#pltDlorentz").prop("checked",!0))}
function setSettings(a){a=JSON.parse(a);simSettn.eVstart=a.Estart;$("#eVstart_touch").val(simSettn.eVstart);simSettn.eVstop=a.Estop;$("#eVstop_touch").val(simSettn.eVstop);makespArr();simSettn.eTr=a.Boltzmann.Epeak_eV;$("#Et_touch").val(simSettn.eTr);simSettn.jdostype=a.jdos&&"qw"==a.jdos?"qw":"bulk";setJdosRadio();a.exiton&&(simSettn.exEb=a.exiton.Eb_meV,$("#eVbind_touch").val(a.exiton.Eb_meV),"QW-2D"==a.exiton.type&&(simSettn.viewDir=a.exiton.viewDir,"parallel"==a.exiton.viewDir?$("#dirPar").prop("checked",
!0):$("#dirPerp").prop("checked",!0),simSettn.polarizat=a.exiton.polarizat,"TM"==a.exiton.polarizat?(simSettn.ex0=a.exiton.shapePar,$("#haideri").css("display","inline"),$("#ex0_touch").val(simSettn.ex0),$("enhTM").prop("checked",!0)):($("#haideri").css("display","none"),$("enhTE").prop("checked",!0))));a.Boltzmann&&(simSettn.kelvin=a.Boltzmann.Temp_K,$("#TemK_touch").val(simSettn.kelvin),$("#Et_touch").val(simSettn.eTr));if(a.InhmgBrdng){if("SymmUrbach"==a.InhmgBrdng.type||"AsymUrbach"==a.InhmgBrdng.type)simSettn.eU=
a.InhmgBrdng.Eu_meV,$("#eveu_touch").val(simSettn.eU);"Gaussian"==a.InhmgBrdng.type&&(simSettn.GauSig=a.InhmgBrdng.sigma_meV,$("#gausig_touch").val(simSettn.GauSig));"Sech^n(t/tau)"==a.InhmgBrdng.type&&(simSettn.SechTau=a.InhmgBrdng.tau_fs,simSettn.SechN=a.InhmgBrdng.n,$("#sechTau_touch").val(simSettn.SechTau),$("#sechN_touch").val(simSettn.SechN))}a.HomogBrdng&&("Lorentz X Lorentz"==a.HomogBrdng.type&&($("#pltDlorentz").prop("checked",!0),$("#pltLorentz").prop("checked",!1),simSettn.DlTau1=a.HomogBrdng.tau1_fs,
$("#tauBe_touch").val(simSettn.DlTau1),simSettn.DlTau2=a.HomogBrdng.tau2_fs,$("#tauBh_touch").val(simSettn.DlTau2)),"Lorentz"==a.HomogBrdng.type&&(simSettn.LorTau=a.HomogBrdng.tau_fs,$("#pltLorentz").prop("checked",!0),$("#pltDlorentz").prop("checked",!1),$("#TauR_touch").val(simSettn.LorTau)))}function gotHomogSim(a){};
