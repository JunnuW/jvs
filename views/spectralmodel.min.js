...
function setSelections(a){console.log("header: ",a);inhomSpectr.inPlot.eV=0<=a.indexOf("(E)")?!0:!1;inhomSpectr.inPlot.jdos=0<=a.indexOf("(qw-jdos)")||0<=a.indexOf("(bulk-jdos)")?!0:!1;inhomSpectr.inPlot.fcv=0<=a.indexOf("(exp[(E-Etr)/kT])")?!0:!1;inhomSpectr.inPlot.Se=0<=a.indexOf("(qw-ex.Enh)")||0<=a.indexOf("(bulk-ex.Enh)")?!0:!1;inhomSpectr.inPlot.convo=!1;inhomSpectr.inPlot.Lurb=!1;inhomSpectr.inPlot.Lsurb=!1;inhomSpectr.inPlot.Lgaus=!1;inhomSpectr.inPlot.Lsech=!1;homSpectr.inPlot.convo=!1;$("#pltHomConv").prop("checked",
...
function setSettings(a){a=JSON.parse(a);console.log("objSettns:",a);simSettn.eVstart=a.Estart;$("#eVstart_touch").val(simSettn.eVstart);simSettn.eVstop=a.Estop;$("#eVstop_touch").val(simSettn.eVstop);makespArr();simSettn.eTr=a.Boltzmann.Epeak_eV;$("#Et_touch").val(simSettn.eTr);simSettn.jdostype=a.jdos&&"qw"==a.jdos?"qw":"bulk";setJdosRadio();a.exiton&&(simSettn.exEb=a.exiton.Eb_meV,$("#eVbind_touch").val(a.exiton.Eb_meV),"QW-2D"==a.exiton.type&&(simSettn.viewDir=a.exiton.viewDir,"parallel"==a.exiton.viewDir?
$("#dirPar").prop("checked",!0):$("#dirPerp").prop("checked",!0),simSettn.polarizat=a.exiton.polarizat,"TM"==a.exiton.polarizat?(simSettn.ex0=a.exiton.shapePar,$("#haideri").css("display","inline"),$("#ex0_touch").val(simSettn.ex0),$("enhTM").prop("checked",!0)):($("#haideri").css("display","none"),$("enhTE").prop("checked",!0))));a.Boltzmann&&(simSettn.kelvin=a.Boltzmann.Temp_K,$("#TemK_touch").val(simSettn.kelvin),$("#Et_touch").val(simSettn.eTr));if(a.InhmgBrdng){if("SymmUrbach"==a.InhmgBrdng.type||
"AsymUrbach"==a.InhmgBrdng.type)simSettn.eU=a.InhmgBrdng.Eu_meV,$("#eveu_touch").val(simSettn.eU);"Gaussian"==a.InhmgBrdng.type&&(simSettn.GauSig=a.InhmgBrdng.sigma_meV,$("#gausig_touch").val(simSettn.GauSig));"Sech^n(t/tau)"==a.InhmgBrdng.type&&(simSettn.SechTau=a.InhmgBrdng.tau_fs,simSettn.SechN=a.InhmgBrdng.n,$("#sechTau_touch").val(simSettn.SechTau),$("#sechN_touch").val(simSettn.SechN))}a.HomogBrdng&&("Lorentz X Lorentz"==a.HomogBrdng.type&&($("#pltDlorentz").prop("checked",!0),$("#pltLorentz").prop("checked",
!1),simSettn.DlTau1=a.HomogBrdng.tau1_fs,$("#tauBe_touch").val(simSettn.DlTau1),simSettn.DlTau2=a.HomogBrdng.tau2_fs,$("#tauBh_touch").val(simSettn.DlTau2)),"Lorentz"==a.HomogBrdng.type&&(simSettn.LorTau=a.HomogBrdng.tau_fs,$("#pltLorentz").prop("checked",!0),$("#pltDlorentz").prop("checked",!1),$("#TauR_touch").val(simSettn.LorTau)))}function gotHomogSim(a){};
