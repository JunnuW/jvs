...
function gotInhomSim(a){var b=a.indexOf("Header:"),c=a.indexOf("Parameters:");try{if(0>b||0>c)throw"Error in simulation settings file";var d=a.substring(c+11,a.length),d=d.trim(),e=a.substring(b+7,a.length),e=e.trim();setSettings(d);console.log("gotinhomsim, simSettn.eTr: ",simSettn.eTr);setSelections(e);setChkboxes();setLegend();makespArr();makeExpArrs();makeJdos();makeBoltz();makeSommer();calcInhom();calcHom();inhombr();hombr()}catch(f){alert("Error in processing simulation settings file")}}
